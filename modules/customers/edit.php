...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $result = $customerObj->update($customerId, $formData);
            if ($result) {
                $_SESSION['flash_message'] = 'Customer "' . htmlspecialchars($formData['name']) . '" has been updated successfully!';
                $_SESSION['flash_type'] = 'success';
                header('Location: index.php');
                exit;
            } else {
                $errors['general'] = 'Failed to update customer. No changes were made or an error occurred.';
            }
        } catch (Exception $e) {
...
<head>
    ...
    <title>Edit Customer - MedWell Pharmacy</title>
    ...
    <style>
        ...
        .form-floating-custom .form-select {
            ...
            font-size: 0.9rem; transition: all 0.25s ease; background: #fff;
        }
        ...
        .form-floating-custom .form-control.is-invalid { border-color: #dc3545; }
        .form-floating-custom .invalid-feedback { font-size: 0.8rem; padding-left: 4px; }
        ...
        .customer-info-banner .avatar {
            width: 48px; height: 48px; border-radius: 50%;
            background: var(--avocado-primary); color: #fff;
            display: flex; align-items: center; justify-content: center;
            font-weight: 700; font-size: 1.2rem;
        }
        .customer-info-banner .info h6 { margin: 0; font-weight: 700; color: #2E3B2F; }
        .customer-info-banner .info small { color: #666; }
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <h3><i class="ri-edit-line"></i> Edit Customer</h3>
            ...
            <div class="customer-info-banner">
                ...
                <div class="info">
                    ...
                    <small>Customer #<?php echo str_pad($customer['id'], 4, '0', STR_PAD_LEFT); ?> &middot; Joined <?php echo date('M d, Y', strtotime($customer['created_at'] ?? 'now')); ?></small>
                </div>
            </div>
                    ...
                    <div class="form-card">
                        <div class="form-card-header">
                            ...
                            <div>
                                ...
                                <small style="opacity:0.8;">Modify the details below and save changes</small>
                            </div>
                        </div>
                        <div class="form-card-body">
                            <form method="POST" action="" novalidate>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                    <div>
                                        <a href="view.php?id=<?php echo $customerId; ?>" class="btn btn-outline-info rounded-3 me-2">
                                    ...
                                    <button type="submit" class="btn btn-avocado px-4">
                                        <i class="ri-save-3-line me-1"></i> Update Customer
                                    </button>
                                </div>
                            </form>
                        </div>
